...
console.log(`${msgtime[Math.floor(Math.random() * msgtime.length)]} ${msgplace[Math.floor(Math.random() * msgplace.length)]} ${msgaction[Math.floor(Math.random() * msgaction.length)]}`);
